...
\setlength\figureheight{0.55\columnwidth}
    \subfloat[Quadratic regression coefficients from validation accuracy to hyperparameters\label{fig:matrix2}]{\input{Figures/hyperparameters3}}
\setlength\figurewidth{0.42\columnwidth}
\setlength\figureheight{0.55\columnwidth}
    \subfloat[Regression and classification performances for validation data\label{fig:accuracy_r3}]{\input{Figures/acc_r2_3}}
\label{fig:hyper}
...
\tiny
\subfloat{\input{Figures/boxplotdx}}\hfill
\subfloat{\input{Figures/boxplotsdy}}\hfill
\subfloat{\input{Figures/boxplotstau}}\\[0.6ex]

% --- Fila 2: dos subfiguras centradas y más juntas ---
\makebox[\textwidth]{%
  \begin{minipage}{\textwidth} % ancho total aproximado de dos subfiguras
    \centering
    \subfloat{\input{Figures/boxplotsmu}}
    % \hspace{0.5cm} % ajusta para modificar separación horizontal
    \subfloat{\input{Figures/boxplotskernel}}
  \end{minipage}%
}
...
\begin{figure}[ht!]
  \centering
  %-------------------------------------------------------------
  \subfloat[\centering Subject 9]{\input{Figures/sliding_9}}
  \subfloat[\centering Subject 8]{\input{Figures/sliding_8}}
  \subfloat[\centering Subject 3]{\input{Figures/sliding_3}}\\
  %-------------------------------------------------------------
  \subfloat[\centering Subject 1]{\input{Figures/sliding_7}}
  \subfloat[\centering Subject 7]{\input{Figures/sliding_1}}
  \subfloat[\centering Subject 5]{\input{Figures/sliding_5}}\hfill
  %-------------------------------------------------------------
  \subfloat[\centering Subject 4]{\input{Figures/sliding_6}}
  \subfloat[\centering Subject 2]{\input{Figures/sliding_4}}
  \subfloat[\centering Subject 6]{\input{Figures/sliding_2}}
  %-------------------------------------------------------------
...
\begin{figure}[H]
  ...
  \resizebox{0.8\textwidth}{!}{\input{Figures/Accuracys}}
