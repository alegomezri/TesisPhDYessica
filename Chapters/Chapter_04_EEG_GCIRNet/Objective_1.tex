...
%------------------------------------------------
 \begin{figure}[H]
  \centering
   \hspace{-25pt} \includegraphics[width=\linewidth]{Figures/Scheme EEG-CIRNET.pdf}
    \caption{The
...
%     point meta=explicit
%   ]
%   table [x=x, y=y, meta=val, col sep=comma] {Figures/ranking_long.csv};
% \end{axis}
% \end{tikzpicture}
% }}} \label{fig:ranking}       
...
% ]
% table [x=x, y=y, meta=val, col sep=comma] {Figures/ttest_pvalues_long.csv};
        ...
        \scalebox{0.60}{%
            \begin{tikzpicture}
                ...
                table[
                    ...
                    meta=val,
                    col sep=comma
                ]{Figures/ttest_pvalues_long.csv};
...
% %-----------------------------------------------
% \begin{figure}[H]
%          \subfloat[]{\includegraphics[height=4.5cm]{Figures/violin_good.pdf}}
%          \label{fig:violin_good}
%          \subfloat[]{\includegraphics[height=4.5cm]{Figures/violin_mid.pdf}}
%          \label{fig:violin_mid}
%          \subfloat[]{\includegraphics[height=4.5cm]{Figures/violin_bad.pdf}}
...
%-----------------------------------------------
\begin{figure}[H]
         \subfloat[Subject 14 group good]{\includegraphics[height=11cm]{Figures/14.pdf}}
         \label{fig:14}
         \subfloat[Subject 27 group mid]{\includegraphics[height=11cm]{Figures/27.pdf}}
         \label{fig:27}
    \vspace{0.4em}
    \begin{tikzpicture}
      \begin{axis}[
...
%------------------------------------------------
\begin{figure}[htbp]
         \subfloat[Subject 14 group good]{\includegraphics[height=6.5cm]{Figures/t-SNE-14-NRVAE.pdf}}
         \label{fig:tsene14_NRVAE}
     \hfill
     \subfloat[Subject 27 group mid]{\includegraphics[height=6.5cm]{Figures/t-SNE-27-NRVAE.pdf}}
